        ...
        <section>
            ...
            <div class="modal modal-bottom sm:modal-middle">
                <div class="modal-box">
                    ...
                    <h3 class="text-secondary font-bold text-lg mb-5">Book: {name}</h3>
                    <form onSubmit={handleBooking} className='grid grid-cols-1 gap-4 justify-items-center'>
                        ...
                        <input type="number" name='phone' placeholder='Phone No' class="input input-bordered w-full max-w-xs" />
                        <input type="submit" value="Submit" class="btn btn-black w-full max-w-xs" />
                    </form>
                </div>
            </div>
        </section>
